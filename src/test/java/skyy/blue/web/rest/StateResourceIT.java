...
public class StateResourceIT {
    ...
    public void createState() throws Exception {
        ...
        assertThat(testState.getValue()).isEqualTo(DEFAULT_VALUE);
        assertThat(testState.getUuid()).isEqualTo(DEFAULT_UUID);
    }
    ...
    public void updateState() throws Exception {
        ...
        assertThat(testState.getValue()).isEqualTo(UPDATED_VALUE);
        assertThat(testState.getUuid()).isEqualTo(UPDATED_UUID);
    }
